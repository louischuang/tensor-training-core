# Android Minimal Integration

This document describes the smallest supported Android integration path for a model exported by this repository.

## Example Project

See:

- `examples/android/minimal-tflite-app/`

The example is intentionally small:

- one activity
- one detector helper
- assets copied from an exported Android bundle
...
`examples/android/minimal-tflite-app/app/src/main/assets/`
...
- validating that the exported Android bundle is self-consistent
- showing the minimum files required by an Android client
- giving mobile developers a code starting point for asset loading and raw output decoding

## What You Still Need For Production

- camera preview pipeline
- image rotation handling
- background execution and backpressure control
- UI overlay rendering
- device-specific performance tuning
- better error handling around missing assets and model mismatches
